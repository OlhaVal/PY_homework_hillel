...
class TestFramesVerification:
    ...
    def test_frame1_verification(self, browser):

        browser.get("http://localhost:8000/dz.html")
    ...
    def test_frame2_verification(self, browser):
    ...
    def test_frame1_incorrect_input(self, browser):

        browser.get("http://localhost:8000/dz.html")

        browser.switch_to.frame("frame1")
        input1 = browser.find_element("id", "input1")
        input1.send_keys("Wrong_Secret")
        time.sleep(3)
        button1 = browser.find_element("tag name", "button")
        button1.click()
        time.sleep(3)
    ...
    def test_frame2_incorrect_input(self, browser):

        browser.get("http://localhost:8000/dz.html")

        browser.switch_to.frame("frame2")
        input2 = browser.find_element("id", "input2")
        input2.send_keys("Wrong_Secret")
        time.sleep(3)
        button2 = browser.find_element("tag name", "button")
        button2.click()
        time.sleep(3)
